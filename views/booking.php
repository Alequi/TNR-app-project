...
<div class="container-xxl mt-2">
    ...
    <main class="container-xxl my-4 flex-grow-1 mt-3">
      ...
      <div class="row mb-4">
        <div class="col-12">
          <h1 class="display-6 fw-bold"> <i class="bi bi-calendar text-primary" style="font-size: 3rem;"></i> Disponibilidad de turnos</h1>
          <p class="text-muted">Fechas disponibles para reservar turnos</p>
        </div>
      </div>
