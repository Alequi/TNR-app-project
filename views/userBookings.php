        ...
        <div class="container-xxl">
            ...
            <?php if ($_SESSION['rol'] === 'voluntario' || $_SESSION['rol'] === 'gestor'): ?>
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a href="userBookings.php" class="nav-link active">Mis reservas</a></li>
            ...
            <div class="col-12 d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="display-6 fw-bold">
                        <i class="bi bi-calendar-check text-primary" style="font-size: 3rem;"></i> Mis Reservas
                    </h1>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0 fw-bold">
                    <i class="bi bi-list-ul me-2"></i>Historial de Reservas
                </h5>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th><i class="bi bi-box-arrow-down text-primary me-1"></i>Entrega</th>
                                <th><i class="bi bi-box-arrow-up text-primary me-1"></i>Recogida</th>
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-3">Comienza reservando un turno para tus gatos</p>
                                            <a href="booking.php" class="btn btn-primary">
                                                <i class="bi bi-plus-circle me-1"></i>Hacer mi primera reserva
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($user_bookings as $booking): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($booking['colonia_nombre']) ?></td>
                                        <td><?= htmlspecialchars($booking['clinica_nombre']) ?></td>
                                        <td>
                                            <?= date('d/m/Y', strtotime($booking['shift_fecha'])) ?>
                                            <span class="badge text-dark bg-light ms-1">
                                                <?= $booking['shift_turno'] === 'M' ? '☀️ Mañana' : '🌙 Tarde' ?>
                                            </span>
                                        </td>
                                        <td>
                                            <?= date('d/m/Y', strtotime($booking['fecha_drop'])) ?>
                                            <span class="badge text-dark bg-light ms-1">
                                                <?= $booking['turno_drop'] === 'M' ? '☀️' : '🌙' ?>
                                            </span>
                                        </td>
                                        <td>
                                            <?= date('d/m/Y', strtotime($booking['fecha_pick'])) ?>
                                            <span class="badge text-dark bg-light ms-1">
                                                <?= $booking['turno_pick'] === 'M' ? '☀️' : '🌙' ?>
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-info text-dark fs-6">
                                                <?= (int)$booking['gatos_count'] ?>
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <?php
                        ...
                        <h3 class="mt-2 mb-0">
                            <?php foreach ($user_bookings as $booking) {
                                if ($booking['estado'] === 'reservado') {
                                    $pending_count = isset($pending_count) ? $pending_count + 1 : 1;
                                }
                            } ?>
                            <?= $pending_count ?? 0 ?>
                        </h3>
            ...
            <div class="col-md-3 mb-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 mb-0">
                            <?php foreach ($user_bookings as $booking) {
                                if ($booking['estado'] === 'entregado_vet') {
                                    $in_clinic_count = isset($in_clinic_count) ? $in_clinic_count + 1 : 1;
                                }
                            } ?>
                            <?= $in_clinic_count ?? 0 ?>
                        </h3>
            ...
            <div class="col-md-3 mb-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 mb-0">
                            <?php foreach ($user_bookings as $booking) {
                                if ($booking['estado'] === 'recogido') {
                                    $completed_count = isset($completed_count) ? $completed_count + 1 : 1;
                                }
                            } ?>
                            <?= $completed_count ?? 0 ?>
                        </h3>
            ...
            <div class="col-md-3 mb-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 mb-0">
                            <?= array_sum(array_column($user_bookings, 'gatos_count')) ?>
                        </h3>
