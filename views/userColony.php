...
<div class="container-xxl mt-2">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Mi colonia</li>
        </ol>
    </nav>
</div>
    ...
    <main class="container-xxl my-4 flex-grow-1 mt-3">
      ...
      <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
          <div>
            <h1 class="display-6 fw-bold"> <i class="bi bi-geo-alt-fill text-primary" style="font-size: 3rem;"></i> Información de la colonia <?php echo htmlspecialchars($user_colony); ?> </h1>
            <p class="text-muted">Estos son los detalles de tu colonia asignada.</p>
          </div>
        </div>
      </div>
        <!-- Estadísticas -->
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 mb-0"><?= $volunteers_count ?></h3>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 mb-0"><?= $gestores_count ?></h3>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 mb-0"><?= $voluntarios_count ?></h3>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0 fw-bold">
                    <i class="bi bi-people me-2"></i>Voluntarios de mi colonia
                </h5>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th><i class="bi bi-calendar text-primary me-1"></i>Desde</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if (empty($colony_volunteers)): ?>
                                <tr>
                                    <td colspan="5" class="text-center py-5">
                                        <div class="text-muted">
                                            <i class="bi bi-inbox fs-1 d-block mb-3"></i>
                                            <h5>No hay voluntarios en esta colonia</h5>
                                            <p class="mb-0">Aún no tienes compañeros asignados</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($colony_volunteers as $volunteer): ?>
                                    <tr>
                                        <td class="fw-semibold"><?= htmlspecialchars($volunteer['nombre']) ?></td>
                                        <td><?= htmlspecialchars($volunteer['email']) ?></td>
                                        <td><?= htmlspecialchars($volunteer['telefono'] ?? 'No disponible') ?></td>
                                        <td>
                                            <?php if ($volunteer['rol'] === 'gestor'): ?>
                                                <span class="badge bg-success">
                                                    <i class="bi bi-person-badge me-1"></i>Gestor
                                                </span>
                                            <?php else: ?>
                                                <span class="badge bg-info">
                                                    <i class="bi bi-person-heart me-1"></i>Voluntario
                                                </span>
                                            <?php endif; ?>
                                        </td>
