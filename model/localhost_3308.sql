...
-- Tiempo de generación: 16-11-2025 a las 13:16:29
...
--
-- Volcado de datos para la tabla `cages`
--

INSERT INTO `cages` (`id`, `clinic_id`, `cage_type_id`, `numero_interno`, `activo`) VALUES
(6, 1, 1, 'V-01', 1),
(7, 1, 1, 'V-02', 1),
(8, 1, 3, 'D-01', 1),
(9, 2, 2, 'G-01', 1),
...
--
-- Volcado de datos para la tabla `cage_loans`
--

INSERT INTO `cage_loans` (`id`, `cage_id`, `from_clinic_id`, `user_id`, `colony_id`, `fecha_prestamo`, `fecha_prevista_devolucion`, `fecha_devolucion`, `estado`, `observaciones`) VALUES
(1, 6, 1, 4, 3, '2025-11-12 20:55:16', '2025-11-22 20:54:11', NULL, 'prestado', 'Jaula para capturas Carrús'),
(2, 9, 1, 8, 6, '2025-11-16 13:13:33', '2025-11-18 13:13:05', NULL, 'prestado', NULL);
...
(8, 'Alejandro', 'Quivera', 'a.quivera1991@gmail.com', '444566887', 'voluntario', '666666666', 1, 8, '2025-11-16 13:12:05');
